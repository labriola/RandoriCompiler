...
public class TargetsMediatorTest extends RandoriTestProjectBase
{
    ...
    public void test_constructor()
    {
        ...
        assertOut("views.mediators.TargetsMediator = function() {\n\tthis.targetList "
    ...
    public void test_onRegister()
    {
        ...
        visitor.visitFunction(node);
        assertOut("views.mediators.TargetsMediator.prototype.onRegister = function() {"
                + "\n\tthis.service.get().then($createDelegate(this, this.handleResult));\n}");
    }
    ...
    public void test_handleResult()
    {
        ...
        visitor.visitFunction(node);
        assertOut("views.mediators.TargetsMediator.prototype.handleResult = function(result) {"
                + "\n\treturn this.targetList.set_data(result);\n}");
    }
    ...
    {
        return "views.mediators.TargetsMediator";
    }
}
