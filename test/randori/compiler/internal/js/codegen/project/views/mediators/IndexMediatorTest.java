...
public class IndexMediatorTest extends RandoriTestProjectBase
{
    ...
    public void test_constructor()
    {
        ...
        assertOut("views.mediators.IndexMediator = function() {"
                + "\n\tthis.viewStack = null;\n\tthis.menu = null;\n\t"
    ...
    public void test_onRegister()
    {
        ...
        visitor.visitFunction(node);
        assertOut("views.mediators.IndexMediator.prototype.onRegister = function() {"
                ...
                + "add($createDelegate(this, this.menuItemSelected));\n\t"
    ...
    public void test_menuItemSelected()
    {
        ...
        visitor.visitFunction(node);
        assertOut("views.mediators.IndexMediator.prototype.menuItemSelected = "
                + "function(menuData) {\n\tthis.viewStack.popView();\n\t"
                + "var promise = this.viewStack.pushView(menuData.url);\n\t"
                + "promise.then($createDelegate(this, function(result) {\n\t}));\n}");
    }
    ...
    {
        return "views.mediators.IndexMediator";
    }
}
